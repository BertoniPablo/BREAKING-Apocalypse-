...
export class Preloader extends Scene {
  ...
  preload() {
    ...
    //cooperativo
    this.load.tilemapTiledJSON("mapajuego", "tilemap/mapajuego.json");
  ...
  create() {
    ...
    this.anims.create({
      key: "PJ1_pala",
      frames: this.anims.generateFrameNumbers("spriteP1", {
        start: 8,
        end: 10,
      }),
      frameRate: 10,
    ...
    this.anims.create({
      key: "PJ2_pico",
      frames: this.anims.generateFrameNumbers("spriteP2", {
        start: 7,
        end: 10,
      }),
      frameRate: 10,
