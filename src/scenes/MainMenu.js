...
export class MainMenu extends Scene {
  ...
  create() {
    ...
    this.p1 = this.physics.add
      .sprite(this.posicionp1.x, this.posicionp1.y, "player1")
      .setScale(0.8);
    this.p2 = this.physics.add
      .sprite(this.posicionp2.x, this.posicionp2.y, "player2")
      .setScale(0.8);

    this.playButton = this.add
      .image(850, 490, "playButton")
      .setInteractive()
      .setScale(0.2)
      .setVisible(true);
    ...
    this.langARButton = this.add
      .image(40, 40, "langARButton")
      .setInteractive()
      .setScale(0.4)
      .setVisible(true);
    ...
    this.langFRButton = this.add
      .image(100, 40, "langFRButton")
      .setInteractive()
      .setScale(0.36)
      .setVisible(true);
    ...
    this.langUSButton = this.add
      .image(160, 40, "langUSButton")
      .setInteractive()
      .setScale(0.36)
      .setVisible(true);
    ...
    this.langALButton = this.add
      .image(220, 40, "langALButton")
      .setInteractive()
      .setScale(0.36)
      .setVisible(true);
    ...
    this.langBRButton = this.add
      .image(280, 40, "langBRButton")
      .setInteractive()
      .setScale(0.36)
      .setVisible(true);
